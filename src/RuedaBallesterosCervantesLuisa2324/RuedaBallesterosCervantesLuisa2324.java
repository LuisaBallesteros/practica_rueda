...
public class RuedaBallesterosCervantesLuisa2324 {
    ...
    public int consumoBallesterosCervantesLuisa = 6;//litros a los cien
  

    
    public RuedaBallesterosCervantesLuisa2324() {
    }

       
    public RuedaBallesterosCervantesLuisa2324(int combustible_queda, int centimos_litro, int capacidad) {
        this.combustible_queda = combustible_queda;
        this.centimos_litro = centimos_litro;
        this.capacidad = capacidad;
    ...
    public void viaje(int km) throws Exception {
        ...
        if (km * this.consumoBallesterosCervantesLuisa/100 > this.getCombustible_queda()) {
        ...
        this.setCombustible_queda(this.getCombustible_queda() - (km * this.consumoBallesterosCervantesLuisa/100)); 
